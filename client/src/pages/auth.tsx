...
import { Activity, Mail, CheckCircle2, Loader2, ArrowRight, ArrowLeft } from "lucide-react";
          ...
          <CardContent>
            <Tabs defaultValue="login" className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-6 rounded-2xl">
                <TabsTrigger value="login" className="rounded-xl" data-testid="tab-login">Login</TabsTrigger>
                <TabsTrigger value="signup" className="rounded-xl" data-testid="tab-signup">Sign Up</TabsTrigger>
              </TabsList>
